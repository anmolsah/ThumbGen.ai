                ...
                >
                  ...
                  >
                    <TrashIcon
                      ...
                      className="size-6 bg-black/50 p-1 rounded hover:bg-brand-600 transition-all"
                    />
                    ...
                    >
                      <ArrowUpRightIcon className="size-6 bg-black/50 p-1 rounded hover:bg-brand-600 transition-all" />
                    </Link>
                  </div>
                </div>
              );
