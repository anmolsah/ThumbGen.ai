...
const PlatformSection = () => {
  ...
  return (
    <section className="py-24 md:py-40 bg-black relative overflow-hidden border-y border-white/5">
       {/* Background Glow */}
       ...
       >
          ...
          >
             <h3 className="text-xl md:text-3xl font-black font-poppins text-white tracking-widest uppercase">ThumbGen</h3>
             <span className="text-brand-400 text-xs md:text-sm mt-2 font-medium tracking-wide">AI CORE</span>
          </motion.div>
